...
class Produto:
    ...
    def edit_produto(self):
        ...
        self.janela_editar.wm_iconbitmap('recursos/M6_P2_icon.ico')
        ...
        self.atualizar_produtos(self.input_nome_novo.get(), self.input_nome_antigo.get(), self.input_preco_novo.get(),
